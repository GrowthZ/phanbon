    ...
    <section className="pt-8 pb-10 px-4 bg-gradient-to-b from-[#E8F5E9] to-white text-center">
      <div className="w-full max-w-lg mx-auto">
        ...
        <RevealOnScroll delay={400} className="space-y-3">
          <Button variant="primary" onClick={handleCtaClick} className="w-full shadow-xl bg-gradient-to-r from-[#FF8F00] to-[#E65100] hover:scale-[1.02] text-[18px] py-4 h-auto uppercase tracking-wide border-2 border-white text-white font-black animate-bounce-slow">
            ĐẶT MUA & NHẬN CÔNG THỨC MIỄN PHÍ
          </Button>
